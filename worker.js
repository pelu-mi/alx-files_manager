...
userQueue.process(async (job, done) => {
  ...
  try {
    const mailSubject = 'Thanks for joining the ALX-Files_Manager family';
    const mailContent = [
      '<div>',
      '<h3>Hello {{user.name}},</h3>',
      'Welcome to <a href="https://github.com/pelu-mi/alx-files_manager">',
      'ALX-Files_Manager</a>, ',
      'a simple file management API built with Express and Node.js by me, ',
      '<a href="https://github.com/pelu-mi">Oluwapelumi</a>. ',
